...
You can use Web3PromiEvent when you send transaction via `web3.qrl.sendTransaction`, `web3.qrl.sendSignedTransaction`, `contractDeployed.methods['methodName'](...methodParams).send` functions
