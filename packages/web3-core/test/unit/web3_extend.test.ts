...
describe('Web3Context extend tests', () => {
	it('Web3Context extend should send correct rpc call', async () => {
		...
		await web3.L2Module.getL2Balance('Q000000000000000000000000000000000000000000000000000000005b43746580AAF00A69019fA59D9ed7d9c85dDd70', 'latest');
	...
	it('Web3Context extend should send correct rpc call without property field defined', async () => {
		...
		await web3.getL0Balance('Q000000000000000000000000000000000000000000000000000000005b43746580AAF00A69019fA59D9ed7d9c85dDd70', 'latest');
