	...
	[
		'should get encoded message with array types',
		{
			...
			message: {
				...
				array2: [
					'Q00000000000000000000000000000000000000000000000000000000CcCCccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC',
					'Q00000000000000000000000000000000000000000000000000000000CD2a3d9F938E13CD947Ec05AbC7FE734Df8DD826',
					'Q00000000000000000000000000000000000000000000000000000000bBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB',
				],
...
export const erroneousTestData: [string, Eip712TypedData, boolean | undefined, Error][] = [
	[
		'should throw error: Cannot encode data: value is not of array type',
		{
			...
			message: {
				array1: ['string', 'string2', 'string3'],
				array2: 'Q00000000000000000000000000000000000000000000000000000000bBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB',
				array3: [123456, 654321, 42],
			},
		},
		false,
