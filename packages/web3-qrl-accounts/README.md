...
You can install the package either using [NPM](https://www.npmjs.com/package/@theqrl/web3-qrl-accounts) or using [pnpm](https://pnpm.io/)
...
```bash
pnpm add @theqrl/web3-qrl-accounts
```
