...
export class Contract<Abi extends ContractAbi>
	extends Web3Context<QRLExecutionAPI, typeof contractSubscriptions>
	implements Web3EventEmitter<ContractEventEmitterInterface<Abi>>
{
	 ...
	 * }
	 *
	 * myContract.options.from = 'Q000000000000000000000000000000000000000000000000000000001234567890123456789012345678901234567891'; // default from address
	 ...
	 * })
	 * .send({
	 *   from: 'Q000000000000000000000000000000000000000000000000000000001234567890123456789012345678901234567891',
	 *   gas: 1500000,
