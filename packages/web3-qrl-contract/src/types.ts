...
export interface NonPayableMethodObject<Inputs = unknown[], Outputs = unknown[]> {
	 ...
	 *
	 * ```ts
	 * await myContract.methods.myMethod(123).send({from: 'Q00000000000000000000000000000000000000000000000000000000de0B295669a9FD93d5F28D9Ec85E40f4cb697BAe'});
	 *
	 ...
	 * const sendObj = myContract.methods.myMethod(123).send({from: 'Q00000000000000000000000000000000000000000000000000000000de0B295669a9FD93d5F28D9Ec85E40f4cb697BAe'})
	 ...
	 *       "blockNumber": 3,
	 *       "contractAddress": "Q0000000000000000000000000000000000000000000000000000000011f4d0A3c12e86B4b5F39B213F7E19D048276DAe",
