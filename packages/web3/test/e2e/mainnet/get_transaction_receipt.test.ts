...
describe(`${getSystemTestBackend()} tests - getTransactionReceipt`, () => {
	...
	it.each(
		...
		expect(result).toMatchObject({
			...
			// contractAddress: 'Q00000000000000000000000000000000000000000000000000000000edfd52255571b4a9a9d4445989e39f5c14ff0447',
			cumulativeGasUsed: BigInt(9010200),
			effectiveGasPrice: BigInt(19330338402),
			from: 'Q00000000000000000000000000000000000000000000000000000000d67da12dc33d9730d9341bbfa4f0b67d0688b28b',
			gasUsed: BigInt(245737),
			logs: [
				{
					address: 'Q000000000000000000000000000000000000000000000000000000002260fac5e5542a773aa44fbcfedf7c193bc2c599',
					blockHash: '0xabc81c29235c7962f5a0420644761627bdc064a560c7d1842cdf9517f7d7984e',
					blockNumber: BigInt(17030310),
				...
				{
					address: 'Q000000000000000000000000000000000000000000000000000000005de8ab7e27f6e7a1fff3e5b337584aa43961beef',
					blockHash: '0xabc81c29235c7962f5a0420644761627bdc064a560c7d1842cdf9517f7d7984e',
					blockNumber: BigInt(17030310),
				...
				{
					address: 'Q00000000000000000000000000000000000000000000000000000000a6e265667e1e18c28f2b5dc529f775c5f0d56d4a',
					blockHash: '0xabc81c29235c7962f5a0420644761627bdc064a560c7d1842cdf9517f7d7984e',
					blockNumber: BigInt(17030310),
				...
				{
					address: 'Q0000000000000000000000000000000000000000000000000000000069a592d2129415a4a1d1b1e309c17051b7f28d57',
					blockHash: '0xabc81c29235c7962f5a0420644761627bdc064a560c7d1842cdf9517f7d7984e',
					blockNumber: BigInt(17030310),
